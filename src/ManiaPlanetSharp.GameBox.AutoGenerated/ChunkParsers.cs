...
namespace ManiaPlanetSharp.GameBox.Parsing.ParserGeneration.AutoGenerated
{
	public static partial class AutoGeneratedParsers
	{
		public static Dictionary<Type, IChunkParser<Chunk>> ChunkParsers { get; } = new Dictionary<Type, IChunkParser<Chunk>> {
			...
			{ typeof(ManiaPlanetSharp.GameBox.Parsing.Chunks.GhostUnknown1Chunk), new GhostUnknown1ChunkParser() },
			...
			{ typeof(ManiaPlanetSharp.GameBox.Parsing.Chunks.ReplayAuthorChunk), new ReplayAuthorChunkParser() },
			{ typeof(ManiaPlanetSharp.GameBox.Parsing.Chunks.ReplayCommunityChunk), new ReplayCommunityChunkParser() },
			{ typeof(ManiaPlanetSharp.GameBox.Parsing.Chunks.ReplayEmbeddedMapChunk), new ReplayEmbeddedMapChunkParser() },
	...
	public class GhostUnknown1ChunkParser
		: PregeneratedChunkParser<ManiaPlanetSharp.GameBox.Parsing.Chunks.GhostUnknown1Chunk>
	{
		public override List<Tuple<uint, bool>> ParseableIds => new List<Tuple<uint, bool>>() { Tuple.Create(0x0309200BU, true) };

        public override ManiaPlanetSharp.GameBox.Parsing.Chunks.GhostUnknown1Chunk Parse(GameBoxReader reader, uint chunkId)
        {
			var result = new ManiaPlanetSharp.GameBox.Parsing.Chunks.GhostUnknown1Chunk() { Id = chunkId };
			result.Unknown = new System.UInt64[reader.ReadUInt32()];
	...
	public class ReplayAuthorChunkParser
		: PregeneratedChunkParser<ManiaPlanetSharp.GameBox.Parsing.Chunks.ReplayAuthorChunk>
	{
		public override List<Tuple<uint, bool>> ParseableIds => new List<Tuple<uint, bool>>() { Tuple.Create(0x03093002U, false) };

        public override ManiaPlanetSharp.GameBox.Parsing.Chunks.ReplayAuthorChunk Parse(GameBoxReader reader, uint chunkId)
        {
			var result = new ManiaPlanetSharp.GameBox.Parsing.Chunks.ReplayAuthorChunk() { Id = chunkId };
			result.Version = reader.ReadUInt32();
			result.AuthorVersion = reader.ReadUInt32();
			result.Login = reader.ReadString();
	...
	public class ReplayEmbeddedMapChunkParser
		: PregeneratedChunkParser<ManiaPlanetSharp.GameBox.Parsing.Chunks.ReplayEmbeddedMapChunk>
	{
		public override List<Tuple<uint, bool>> ParseableIds => new List<Tuple<uint, bool>>() { Tuple.Create(0x03093002U, false) };

        public override ManiaPlanetSharp.GameBox.Parsing.Chunks.ReplayEmbeddedMapChunk Parse(GameBoxReader reader, uint chunkId)
        {
			var result = new ManiaPlanetSharp.GameBox.Parsing.Chunks.ReplayEmbeddedMapChunk() { Id = chunkId };
		...
		: PregeneratedChunkParser<ManiaPlanetSharp.GameBox.Parsing.Chunks.ReplayVersionChunk>
	{
        ...
        public override ManiaPlanetSharp.GameBox.Parsing.Chunks.ReplayVersionChunk Parse(GameBoxReader reader, uint chunkId)
        {
			...
			if (result.Version >= 2)
			{
			    result.TrackUid = reader.ReadString();
			}
			if (result.Version >= 2)
			{
			    result.TrackEnvironment = reader.ReadString();
			}
			if (result.Version >= 2)
			{
			    result.TrackAuthor = reader.ReadString();
			}
			if (result.Version >= 2)
			{
