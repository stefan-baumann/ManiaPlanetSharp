...
namespace ManiaPlanetSharp.GameBox.Parsing.ParserGeneration.AutoGenerated
{
		...
		: PregeneratedChunkParser<ManiaPlanetSharp.GameBox.Parsing.Chunks.ObjectItemTypeChunk>
	{
        ...
        {
			var result = reader.BodyMode ? new ManiaPlanetSharp.GameBox.Parsing.Chunks.ObjectItemTypeChunk() { Id = reader.ReadUInt32() } : new ManiaPlanetSharp.GameBox.Parsing.Chunks.ObjectItemTypeChunk();
		...
		: PregeneratedChunkParser<ManiaPlanetSharp.GameBox.Parsing.Chunks.ObjectUnknownChunk>
	{
        ...
        {
			var result = reader.BodyMode ? new ManiaPlanetSharp.GameBox.Parsing.Chunks.ObjectUnknownChunk() { Id = reader.ReadUInt32() } : new ManiaPlanetSharp.GameBox.Parsing.Chunks.ObjectUnknownChunk();
			result.Unknown = reader.ReadUInt32();
			return result;
        }
	}
